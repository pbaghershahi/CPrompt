...
class GraphTask(BaseTask):
    def __init__(self, *args, **kwargs):    
        ...
        self.load_data()
        self.initialize_gnn()
        """ Peyman: initializes the prompting method based on self.prompt_type. 
        In our case self.prompt_type should be: All-in-one. """
        self.initialize_prompt()
        """ Peyman: self.answering is the decoder function trained for different datasets individually."""
    ...
    """ Peyman: This function is later used to get the loss function in the run function."""
    def AllInOneTrain(self, train_loader):
        ...
        for epoch in range(1, answer_epoch + 1):
            """ Peyman: Calls the Tune function of the Heavyprompt to train the decoder or task header
            and prompt matrix parameters are fixed in this step. """
        ...
        for epoch in range(1, prompt_epoch + 1):
            """ Peyman: Calls the Tune function of the Heavyprompt to prompt matrix parameters
            and the decoder or task header are fixed in this step. """
